...
${OBJECTDIR}/Labyrinthe.o: Labyrinthe.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 `pkg-config --cflags gtk+-2.0`   -MMD -MP -MF $@.d -o ${OBJECTDIR}/Labyrinthe.o Labyrinthe.c

${OBJECTDIR}/main.o: main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 `pkg-config --cflags gtk+-2.0`   -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.c
